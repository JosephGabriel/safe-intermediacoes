    ...
    <section class="pt-5" id="diversifique">
        <div class="container mt-5 d-flex justify-content-center align-items-center">
            <div class="benefits w-100">
                <h1 class="benefits-title">Invista sem</h1>
                <h1 class="benefits-title-alt mb-3">COMPLICAÇÕES</h1>
                <p class="text-italic mb-5">Você não vai precisar fazer nenhuma análise. Apenas acompanhar os resultados
                </p>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 mb-5">
                        <div class="benefits-card">
                            ...
                            <p class="benefits-text">
                                Você <span class="benefits-spot">abre sua conta na safe</span> e faz seu depósito
                            </p>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-12 mb-5">
                        <div class="benefits-card">
                            ...
                            <p class="benefits-text">Nossos <span class="benefits-spot">especialistas investem
                                </span>seu dinheiro</p>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-12 mb-5">
                        <div class="benefits-card">
                            ...
                            <p class="benefits-text">Você <span class="benefits-spot">acompanha o crescimento</span> da
                                sua renda todos os dias
                            </p>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-12 mb-5">
                        <div class="benefits-card">
                            ...
                            <p class="benefits-text">Garantia de <span class="benefits-spot">6 meses
                                    contra</span> prejuízos</p>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                                ...
                                <div class="accordion-body">
                                    <p class="m-0">Sim! Nossos contratos tem validade de 180 dias. E, apesar da
                                        permanência mínima
                                        de 90 dias, ao término do contrato todos os prejuízos, caso tenham, são
                                        absorvidas. </p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree"
                                ...
                                <div class="accordion-body">
                                    <p class="m-0">O valor mínimo recomendado é um aparte que você não tenha necessidade
                                        de uso
                                        entre 90 e 180 dias.
                                        O depósito é feito via PiX ou TED. </p>
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item">
                            ...
                            <div id="collapseNine" class="accordion-collapse collapse" aria-labelledby="headingThree"
                                ...
                                <div class="accordion-body">
                                    <p class="m-0">Ao final do último dia útil do mês em questão o balanço das operações
                                        ...
                                        creditadas do 1• ao 5• dia útil do mês seguinte ao das operações.</p>
                                </div>
                            </div>
                        </div>
                    </div>
